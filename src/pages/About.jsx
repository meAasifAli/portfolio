            ...
            <div className="flex flex-col   sm:w-[80%] mx-auto sm:flex-row  justify-center gap-8 sm:gap-24 py-4 transition-all duration-200 delay-100 ease-in-out">
                ...
                <div className="flex flex-col gap-6">
                    <h2 data-aos="fade-up"
                        ...
                        data-aos-mirror="true"
                        data-aos-once="false"
                        data-aos-anchor-placement="top-center" className='text-2xl font-bold'>Full Stack Developer</h2>
                    <p data-aos="fade-up"
                        data-aos-offset="200"
                        data-aos-delay="50"
                        data-aos-duration="1000"
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                        <div data-aos="fade-up"
                            ...
                            data-aos-mirror="true"
                            data-aos-once="false"
                            data-aos-anchor-placement="top-center" className='flex flex-col gap-4'>
                    ...
                    <div data-aos="fade-up"
                        ...
                        data-aos-mirror="true"
                        data-aos-once="false"
                        data-aos-anchor-placement="top-center" className='transition-all duration-200 delay-150 ease-in-out flex flex-row  justify-between md:justify-normal sm:gap-8 px-1 py-4 md:py-8  mt-2 '>
